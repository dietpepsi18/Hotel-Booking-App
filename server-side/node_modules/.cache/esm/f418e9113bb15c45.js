let User,jwt;_3bb‍.x([["register",()=>register],["login",()=>login]]);_3bb‍.w("../mongoDB_models/user.js",[["default",["User"],function(v){User=v}]]);_3bb‍.w("jsonwebtoken",[["default",["jwt"],function(v){jwt=v}]]); //User is userModel
  ...
  try {
    ...
    _3bb‍.g.console.log("CREATE USER FAILED", err);
