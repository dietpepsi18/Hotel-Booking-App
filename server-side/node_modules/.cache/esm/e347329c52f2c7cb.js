let express,readdirSync,mongoose,cors;_52f‍.w("express",[["default",["express"],function(v){express=v}]]);_52f‍.w("fs",[["readdirSync",["readdirSync"],function(v){readdirSync=v}]]);_52f‍.w("mongoose",[["default",["mongoose"],function(v){mongoose=v}]]);_52f‍.w("cors",[["default",["cors"],function(v){cors=v}]]);//the entry file of the server
...
mongoose
  ...
  .catch((err) => _52f‍.g.console.log("Database connection error: ", err));
